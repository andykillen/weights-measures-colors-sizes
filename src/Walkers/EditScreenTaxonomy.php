...
namespace WMCS\Walkers;

use \Walker;

class EditScreenTaxonomy extends Walker {
        ...
        public $text_filter_name = 'the_category';
        ...
        public function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 ) {
            if ( empty( $args['taxonomy'] ) ) {
                ...
                $this->text_filter_name = $args['taxonomy'] . '_item_text_filter';
            }
            ...
            if ( ! empty( $args['list_only'] ) ) {
                ...
                $output .= "\n<li id='{$taxonomy}-{$category->term_id}'$class>" .
                    ...
                    /** This filter is documented in wp-includes/category-template.php */
                    esc_html( apply_filters( $this->text_filter_name, $category->name, '', '' ) ) . '</label>';
            }
        }
